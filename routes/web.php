...
Route::get('/student/{student}/edit', [App\Http\Controllers\StudentController::class, 'edit'])->middleware([App\Http\Middleware\IsAuth::class])->name('student.edit');
Route::post('/student/{student}/edit', [App\Http\Controllers\StudentController::class, 'update'])->middleware([App\Http\Middleware\IsAuth::class])->name('student.update');
Route::get('/student/{student}/delete', [App\Http\Controllers\StudentController::class, 'destroy'])->middleware([App\Http\Middleware\IsAuth::class])->name('student.delete');
